...
@pytest.mark.parametrize('username',
                         [
                             ...
                             support_steps.generate_random_letter_number_strings(8)
                         ],
                         ids=["sold", "available"]
                         )
...
def test_get_user():
    ...
    url_get_user = urls.url_get_user(username)
    # отправить запрос
...
def test_put_negative_user():
    ...
    url_put_user = urls.url_get_user(username1)
    response_put_user = requests_steps.request_put(url_put_user, request)
    print("response_put_user =", response_put_user.status_code)
...
#pytest test_post -n3
#pytest test_user_api.py --alluredir=/Users/20071554/PycharmProjects/python_api_project/venv/reports
#allure serve /Users/20071554/PycharmProjects/python_api_project/venv/reports
#export PATH="$PATH:/Applications/allure-2.17.3/bin"